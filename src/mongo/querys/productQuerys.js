...
export const getProductsFromDbWithFilter = async (limit, page, query, sort) => {
  try {
    ...
    throw new InternalServerError(
      `Error de base de datos al obtener productos con filtro: ${error.message}`
    );
  }
};
...
export const getProductByIdFromDb = async (id) => {
  try {
    ...
    throw new InternalServerError(
      `Error de base de datos al obtener producto con ID ${id}: ${error.message}`
    );
  }
};
...
export const updateProductInDb = async (id, product) => {
  try {
    ...
    throw new InternalServerError(
      `Error de base de datos al actualizar producto con ID ${id}: ${error.message}`
    );
  }
};
...
export const deleteProductFromDb = async (id) => {
  try {
    ...
    throw new InternalServerError(
      `Error de base de datos al eliminar producto con ID ${id}: ${error.message}`
    );
  }
};
